...
public class VariableExample {
	...
	public static void main(String[] args) {		
        ...
        */
		...
		//변수의 초기화(initialization): [변수명] = [값];
		age = 40; // = : 대입 연산자(assignment operator)  좌항:area 우항:value
...
//		int result = myScore + num;(x) num이 뭔지 모른다.
		int result;
//		System.out.println(result); result는 초기화 되지 않아서 사용불가능
