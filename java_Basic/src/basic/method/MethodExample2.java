...
public class MethodExample2 {
	...
	//정수를 n개를 전달하면 그 정수들의 총 합을 리턴하는 메서드
	static int calcNerTotal(int[] nums) {
		int total = 0;
//		for(int n : nums) {
//			total += n;
//		}
	...
	//콤마로 나열되어 들어오는 여러개의 값을 배열로 묶어서 내부로 저달합니다.
	...
	public static void main(String[] args) {
		...
		int sum = calcNerTotal(arr);
		System.out.println("누적합: " + sum);
		
		sum = calcNerTotal(new int[] {1, 2, 3, 4, 5, 6, 7});
		System.out.println("누적합: " + sum);	
