...
public class Identifier {
	...
	public static void main(String[] args) {
		...
		int age = 35;
//		int age =40;(x)
		int Age = 40; // age와 Age 대/소문자 구분
		
		System.out.println(age);
		System.out.println(Age);
		
		//2. 식별자 이름은 숫자로 지정하거나 숫자로 시작하시면 안됩니다.
//		int 700 = 365; (x) 숫자로 지정 불가
//		int 7number = 7; (x) 숫자로 시작불가
		int number7 = 7;
		int num7ber = 7;
		int num123ber = 123;
...
//		int my birth day = 19921013; (x)
		...
		int my_birth_day = 19921013; // snake case 표기법 자바보다는 c나 파이썬에서 많이 쓰인다.
		int myBirthDay = 19921013; // camel case 표기법 자바에서 많이 쓰인다.
		
		//4. 식별자에 쓸 수 있는 특수문자는 밑줄(_), 달러($)
...
//		String class = "클래스"; (x)
		String Class = "클래스"; // (권장하지 않습니다.) 혼동할 가능성이 높음 
		String calssName = "클래스";
